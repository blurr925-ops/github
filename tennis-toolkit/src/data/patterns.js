...
export const rallies = [
  // ============ GREEN (Beginner) ============
  {
    ...
    steps: [
      ...
      },
      {
        ...
        explanation: 'Short ball = attack! Down the line to the open court. Brilliant!',
        wrongExplanation: 'When you get a short ball, attack the OPEN court. Your opponent is on the left — go DOWN THE LINE to the right!',
    ...
    steps: [
      {
        ...
        wrongExplanation: 'On the return, go DEEP CROSS-COURT. From your left, that means far right! Stay safe.',
        opponentPosition: { x: 0.5, y: 0.12 },
      },
      {
        description: 'Your opponent is under pressure and hits it SHORT to your right. Attack!',
        ballPosition: { x: 0.6, y: 0.48 },
        correctZone: { x: 0.75, y: 0.18, radius: 0.25 },
        correctLabel: 'Attack down the line!',
        explanation: 'Return deep, then attack the short ball. Textbook tennis!',
        wrongExplanation: 'Your opponent is on the LEFT from the rally. Short ball = attack DOWN THE LINE to the right!',
        opponentPosition: { x: 0.3, y: 0.25 },
      },
    ],
  },
    ...
    steps: [
      {
        ...
        wrongExplanation: 'Approach shots should go DOWN THE LINE. From the right side, aim far right and rush to the net!',
        opponentPosition: { x: 0.3, y: 0.15 },
      },
      {
        description: 'You\'re at the net! Your opponent scrambles and hits it to your LEFT. Volley it away!',
        ballPosition: { x: 0.3, y: 0.4 },
        correctZone: { x: 0.75, y: 0.15, radius: 0.28 },
        correctLabel: 'Volley to open court!',
        explanation: 'Clinical! Approach, net, volley to the open side. Champion play!',
        wrongExplanation: 'At the net, volley to the OPEN court! Your opponent is on the left — volley RIGHT!',
        opponentPosition: { x: 0.2, y: 0.2 },
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        ballPosition: { x: 0.7, y: 0.7 },
        correctZone: { x: 0.25, y: 0.15, radius: 0.25 },
        correctLabel: 'Deep cross-court!',
  ...
  },
  {
    ...
    steps: [
      ...
      {
        description: 'Your opponent charges to the net! They\'re covering the cross-court. Ball to your right — pass them!',
        ...
        wrongExplanation: 'Your opponent is at the net covering cross-court. Pass them DOWN THE LINE to the far right!',
    ...
    steps: [
      {
        ...
        correctZone: { x: 0.5, y: 0.1, radius: 0.28 },
        correctLabel: 'LOB! High and deep!',
        explanation: 'Smart play! A high lob over their head buys you time!',
        wrongExplanation: 'When you\'re stretched wide and your opponent is at the net, LOB it HIGH and DEEP over their head!',
        opponentPosition: { x: 0.45, y: 0.35 },
      },
      {
        description: 'Your lob worked! They chased it back and hit a weak ball to the middle. They\'re off balance!',
        ballPosition: { x: 0.5, y: 0.55 },
        correctZone: { x: 0.2, y: 0.18, radius: 0.25 },
        correctLabel: 'Attack the open court!',
        explanation: 'Defended, lobbed, then attacked. Tennis IQ through the roof!',
        wrongExplanation: 'Your opponent scrambled to the RIGHT to get the lob. The open court is on the LEFT — attack it!',
  ...
  // ============ RED (Advanced) ============
  {
    ...
    steps: [
      ...
      {
        description: 'Your opponent is already moving RIGHT to cover cross-court. They\'re cheating! Wrong-foot them!',
        ...
        wrongExplanation: 'Your opponent is running RIGHT. Hit it LEFT — behind them! They can\'t change direction!',
  ...
  },
  {
    ...
    steps: [
      {
        description: 'You served wide! Your opponent barely got it back to the middle. The right side is wide open!',
        ...
        wrongExplanation: 'After a wide serve, your opponent is stretched far LEFT. Attack the OPEN court on the RIGHT!',
        opponentPosition: { x: 0.15, y: 0.15 },
      },
      {
        description: 'Weak reply comes back short to your right. Move forward and keep attacking!',
        ballPosition: { x: 0.6, y: 0.5 },
        correctZone: { x: 0.75, y: 0.18, radius: 0.24 },
        correctLabel: 'Approach down the line!',
        explanation: 'Perfect approach shot! Now rush to the net!',
        wrongExplanation: 'Short ball = approach DOWN THE LINE to the far right, then follow it to the net!',
        opponentPosition: { x: 0.3, y: 0.2 },
      },
      {
        description: 'You\'re at the net! Your opponent tries to pass you to your LEFT. Finish it!',
        ballPosition: { x: 0.25, y: 0.42 },
        ...
        wrongExplanation: 'At the net, volley to the OPEN side! Ball on your left, so volley CROSS-COURT to the far right!',
  ...
  },
  {
    ...
    steps: [
      ...
      {
        description: 'They attack your backhand AGAIN! But this time, flip the script!',
        ...
        wrongExplanation: 'Change direction! Go DOWN THE LINE to the far LEFT — they\'re expecting cross-court!',
        opponentPosition: { x: 0.7, y: 0.15 },
      },
      {
        description: 'Your opponent scrambles and hits a weak short ball. They\'re off balance. End it!',
        ballPosition: { x: 0.45, y: 0.5 },
        correctZone: { x: 0.8, y: 0.18, radius: 0.24 },
        correctLabel: 'Finish to the open court!',
        explanation: 'WHAT A COMEBACK! Defended, changed direction, then attacked. Champion tennis!',
        wrongExplanation: 'Your opponent is scrambling on the LEFT. Finish to the OPEN court on the RIGHT!',
