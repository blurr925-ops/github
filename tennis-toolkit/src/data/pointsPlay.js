export const levels = [
  {
    ...
    brief: {
      opponent: 'Alex',
      strengths: ['Powerful forehand', 'Good movement to the right'],
      weaknesses: ['Weak one-handed backhand', 'Slow recovery to the left'],
      tactic: 'Target the backhand side to force errors.',
    },
    steps: [
      {
        ...
        wrongZoneFeedback: 'That goes to the forehand side — Alex\'s strength! Target the backhand.',
      },
      {
        ...
        wrongZoneFeedback: 'Don\'t hit back to Alex — the open court is on the other side!',
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        correctZone: { x: 0.3, y: 0.25, radius: 0.15 },
        shotFeedback: {
          ...
          approach: { correct: true, text: 'Perfect approach! You slice it deep to her backhand and close the net. Mia can\'t pass you — point won!' },
        },
        wrongZoneFeedback: 'Approach down the line to cut off the passing shot angle.',
      },
    ],
  },
  {
    ...
    brief: {
      ...
      tactic: 'Move Sam wide first, THEN approach on the short ball.',
    },
    steps: [
      {
        ballPosition: { x: 0.5, y: 0.85 },
    ...
    steps: [
      {
        ...
        correctShot: 'topspin',
        correctZone: { x: 0.3, y: 0.2, radius: 0.16 },
        shotFeedback: {
        ...
        wrongZoneFeedback: 'Hit deep! A short ball lets Jordan stay comfortable in the rally.',
      },
      {
        ballPosition: { x: 0.4, y: 0.84 },
        opponentPosition: { x: 0.35, y: 0.08 },
        description: 'Jordan is pinned deep. Keep building!',
        correctShot: 'topspin',
        correctZone: { x: 0.75, y: 0.2, radius: 0.15 },
        shotFeedback: {
      ...
      },
      {
        ...
        wrongZoneFeedback: 'The open court is away from Jordan — approach to the gap!',
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        shotFeedback: {
          topspin: { correct: true, text: 'Topspin passing shot down the line! Casey stretches but can\'t reach it.' },
        ...
        wrongZoneFeedback: 'Pass Casey down the line — the gap is on the right side!',
      },
      {
        ballPosition: { x: 0.7, y: 0.8 },
    ...
    steps: [
      {
        ...
        opponentPosition: { x: 0.5, y: 0.1 },
        description: 'Marcus fires a big serve to your forehand side!',
        correctShot: 'slice',
      ...
      },
      {
        ...
        correctShot: 'topspin',
        correctZone: { x: 0.3, y: 0.22, radius: 0.15 },
        shotFeedback: {
        ...
        wrongZoneFeedback: 'Target the backhand side — don\'t feed Marcus\'s forehand!',
      },
      {
        ballPosition: { x: 0.35, y: 0.8 },
        opponentPosition: { x: 0.35, y: 0.16 },
        description: 'Marcus gets impatient and goes for too much — it lands short!',
        correctShot: 'approach',
        correctZone: { x: 0.7, y: 0.22, radius: 0.15 },
        shotFeedback: {
          ...
          approach: { correct: true, text: 'You approach deep to the open side and close the net. Marcus panics and hits into the net. Patience wins!' },
        },
        wrongZoneFeedback: 'Approach to the open court — don\'t go back to Marcus!',
      },
    ],
  },
  {
    ...
    brief: {
      ...
      tactic: 'Mix topspin and slice to break Taylor\'s rhythm — never let Taylor settle.',
    },
    steps: [
      {
        ballPosition: { x: 0.5, y: 0.85 },
        ...
        correctShot: 'slice',
        correctZone: { x: 0.35, y: 0.28, radius: 0.15 },
        shotFeedback: {
          topspin: { correct: false, text: 'Topspin plays into Taylor\'s rhythm — same pace, same bounce. Mix it up!' },
          slice: { correct: true, text: 'Nice change of pace! The low slice disrupts Taylor\'s timing.' },
          approach: { correct: false, text: 'Don\'t rush in yet — work on breaking Taylor\'s rhythm first.' },
        },
        wrongZoneFeedback: 'Aim deep to the backhand side — keep Taylor uncomfortable.',
      },
      {
        ballPosition: { x: 0.4, y: 0.84 },
        opponentPosition: { x: 0.4, y: 0.14 },
        description: 'Taylor adjusts to the low ball. Now switch it up!',
        correctShot: 'topspin',
        correctZone: { x: 0.75, y: 0.2, radius: 0.15 },
        shotFeedback: {
          topspin: { correct: true, text: 'From low slice to heavy topspin! The ball kicks up high and Taylor is completely wrong-footed by the speed change.' },
      ...
      {
        ballPosition: { x: 0.6, y: 0.82 },
        opponentPosition: { x: 0.7, y: 0.16 },
        description: 'Taylor is struggling with the changes. Keep mixing!',
        correctShot: 'slice',
        correctZone: { x: 0.3, y: 0.3, radius: 0.15 },
        shotFeedback: {
          topspin: { correct: false, text: 'Going topspin again lets Taylor re-find the rhythm. Keep mixing!' },
          slice: { correct: true, text: 'Another speed change! Taylor expects topspin but gets a low skidding slice. Completely fooled!' },
          approach: { correct: false, text: 'Almost time but not yet — one more change of pace will break Taylor.' },
        },
        wrongZoneFeedback: 'Go back to the other side — don\'t let Taylor settle.',
      },
      {
        ballPosition: { x: 0.35, y: 0.76 },
        opponentPosition: { x: 0.35, y: 0.2 },
        ...
        wrongZoneFeedback: 'Approach to the open side — Taylor is stranded!',
      },
    ],
  },
  {
    ...
    steps: [
      {
        ...
        wrongZoneFeedback: 'Start by going to the backhand side — open up the court.',
      },
      {
        ballPosition: { x: 0.3, y: 0.84 },
        opponentPosition: { x: 0.25, y: 0.16 },
        description: 'The coach gets it back crosscourt. Change the pace!',
        correctShot: 'slice',
        correctZone: { x: 0.7, y: 0.3, radius: 0.15 },
        shotFeedback: {
        ...
        wrongZoneFeedback: 'Go crosscourt to the forehand side — change direction AND pace.',
      },
      {
        ballPosition: { x: 0.65, y: 0.82 },
        opponentPosition: { x: 0.65, y: 0.15 },
        description: 'The coach adjusts but is slightly off-balance. Keep constructing!',
        correctShot: 'topspin',
        correctZone: { x: 0.15, y: 0.22, radius: 0.14 },
        shotFeedback: {
        ...
        wrongZoneFeedback: 'Pull the coach wide to the backhand — create the opening!',
      },
      {
        ballPosition: { x: 0.25, y: 0.78 },
        opponentPosition: { x: 0.15, y: 0.2 },
        description: 'The coach is stretched wide and hits a weak reply. Build more or attack?',
        correctShot: 'topspin',
        correctZone: { x: 0.8, y: 0.24, radius: 0.14 },
        shotFeedback: {
          topspin: { correct: true, text: 'You send it deep to the open court — the coach is in full sprint!' },
        ...
        wrongZoneFeedback: 'The open court is on the far side — make the coach run!',
      },
      {
        ballPosition: { x: 0.7, y: 0.74 },
        opponentPosition: { x: 0.8, y: 0.22 },
        ...
        wrongZoneFeedback: 'The coach is stuck wide right — approach to the wide open left side!',
      },
    ],
  },
];
