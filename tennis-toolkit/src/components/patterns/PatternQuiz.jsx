...
import CourtBirdEye from '../court/CourtBirdEye';
    ...
    <div className="min-h-screen bg-navy pb-8">
      ...
      <div className="px-4 mb-4">
        <div className="bg-navy-light rounded-2xl p-4">
          ...
          {result === null && (
            <p className="text-tennis text-sm mt-2 font-medium">
      ...
      <div className="px-4">
        {result === 'correct' && (
          <div className="bg-green-500/10 border border-green-500/30 rounded-2xl p-5 text-center animate-in fade-in duration-300">
            ...
            <button
              ...
              className="w-full bg-tennis text-navy font-bold py-3 px-6 rounded-xl text-base active:scale-[0.98] transition-transform min-h-[48px]"
            >
              Continue
            </button>
          </div>
        ...
        {result === 'wrong' && (
          <div className="bg-orange-500/10 border border-orange-500/30 rounded-2xl p-5 text-center animate-in fade-in duration-300">
            ...
            <button
              onClick={handleRetry}
              className="w-full bg-navy-lighter text-white font-semibold py-3 px-6 rounded-xl text-base flex items-center justify-center gap-2 active:scale-[0.98] transition-transform min-h-[48px]"
            >
